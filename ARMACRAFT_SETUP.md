...
For a 5 km x 5 km playable area, use a 5000-block world border on the Java server. That is 25 km² = 2500 hectares. Let the Java server generate chunks as players explore.
